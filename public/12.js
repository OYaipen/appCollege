      ...
      _c(
        ...
        _vm._l(_vm.plans, function(item, index) {
          return _c("tr", { key: index }, [
            _c("td", [_vm._v(_vm._s(item.nombreP))]),
            _vm._v(" "),
            _c("td", [_vm._v(_vm._s(item.mesesP))]),
            _vm._v(" "),
            _c("td", [_vm._v(_vm._s(item.precioP))]),
            _vm._v(" "),
            _c("td", [_vm._v(_vm._s(item.precioM))]),
            _vm._v(" "),
            _vm._m(1, true)
          ])
        }),
  ...
  function() {
    ...
    return _c("thead", { staticClass: "thead-dark" }, [
      _c("tr", [
        ...
        _vm._v(" "),
        _c("th", { attrs: { scope: "col" } }, [_vm._v("Meses")]),
        _vm._v(" "),
        _c("th", { attrs: { scope: "col" } }, [_vm._v("Mensualidad")]),
        _vm._v(" "),
        _c("th", { attrs: { scope: "col" } }, [_vm._v("Matricula")]),
        _vm._v(" "),
